...
export const generateProductCatalogXLSX = (products: any[]): string => {
  // Header
  let content = 'Unidade\tProduto\tAbreviação\tCategoria\tFórmula Ativa\tAplicação\tDificuldade\tNotas\n';
...
export const generateProductCatalogCSV = (recipes: any[], chemistry: any[], procedures: any[]): string => {
