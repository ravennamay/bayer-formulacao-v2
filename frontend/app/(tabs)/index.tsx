...
/* COMPONENTES */
function SitRow({ label, value, color, bg, icon, colors }: any) {
  return (
    <View style={styles.sitRow}>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
        ...
        <Text style={{ color: colors.textPrimary, fontWeight: '600', fontSize: 14 }}>{label}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  sitRow: { flexDirection: 'row', justifyContent: 'space-between', padding: 12 },
  sitIcon: {
    width: 36,
    height: 36,
    borderRadius: 10,
