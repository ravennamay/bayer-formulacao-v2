            ...
            >
              <View style={styles.productCardContent}>
                <View style={{ flex: 1 }}>
                  ...
                  {product.description && (
                    <Text style={[styles.productDesc, { color: colors.textTertiary }]} numberOfLines={2}>
                      {product.description}
                    </Text>
                  )}
                </View>
                  ...
                  <View style={styles.detailsSection}>
                    ...
                    {selectedProduct.ingredients.map((ing, idx) => (
                      <View key={idx} style={styles.ingredientRow}>
                        <Text style={[styles.ingredientBullet, { color: colors.primary }]}>
                          •
                        </Text>
          ...
          <ScrollView contentContainerStyle={styles.formContent}>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                ...
                onChangeText={v => setNewProduct({ ...newProduct, weight: v ? parseFloat(v) : undefined })}
